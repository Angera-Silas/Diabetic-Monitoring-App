...
class GlucoseChartMedicationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fetchBloodSugarDataByMedicationRealTime()
    }

    private fun fetchBloodSugarDataByMedicationRealTime() {
        firestore.collection("glucose_entries")
            .whereEqualTo("userId", userId)
            .orderBy("timestamp")
            .addSnapshotListener { snapshots, e ->
                if (e != null) {
                    Log.w("GlucoseChartMedication", "Listen failed.", e)
                ...
                if (snapshots != null) {
                    ...
                    for (document in snapshots) {
                        ...
                        if (bloodSugar != null && timestamp != null && medication.isNotEmpty()) {
                            ...
                            Log.d("GlucoseChartMedication", "Skipping document: ${document.id}")
                        }
                    }
